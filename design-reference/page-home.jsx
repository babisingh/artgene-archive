  ...
  return (
    <div className="route">
        ...
        <div className="wrap grid-12" style={{alignItems:'start', gap:48}}>
          <div style={{gridColumn:'span 7'}}>
            ...
            <p className="lede" style={{maxWidth:620, margin:'0 0 36px'}}>
              Generative models now produce proteins, genes and regulatory elements faster than the scientific community can catalogue them. ArtGene Archive is the first dedicated registry for AI-designed biological sequences — providing watermarking, biosafety certification, and an auditable chain of custody from model to bench to publication.
            </p>
            <div className="flex gap-12" style={{alignItems:'center'}}>
              <button className="btn btn-primary" onClick={()=>setRoute('register')}>
                Deposit a sequence
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M1 6h10M7 2l4 4-4 4" stroke="currentColor" strokeWidth="1"/></svg>
              </button>
              <button className="btn btn-ghost" onClick={()=>setRoute('record')}>View an example record</button>
              <a className="mono" style={{fontSize:11.5,color:'var(--ink-3)',letterSpacing:'0.08em',textTransform:'uppercase',marginLeft:16}}>
      ...
      <section className="wrap" style={{padding:'64px 0 40px'}}>
        <div style={{display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:0, borderTop:'0.5px solid var(--rule)'}}>
          {[
      ...
      <section className="wrap" style={{padding:'72px 0'}}>
        <div className="grid-12" style={{alignItems:'start', gap:48}}>
          ...
          <div style={{gridColumn:'span 7', gridColumnStart: 6, fontSize:16.5, lineHeight:1.7, color:'var(--ink-2)'}}>
            <p style={{marginTop:0}}>
            ...
            <p>
              <strong>ArtGene Archive is that infrastructure.</strong> We provide a dedicated deposit path, automated three-gate biosafety screening, cryptographic watermarking via codon steganography, tamper-evident certification, and formal recognition for contributors. Deposits are free. Records are public. The registry is governed by an international consortium, not a vendor.
            </p>
            <p className="mono" style={{fontSize:13,color:'var(--ink-3)',marginTop:28,paddingLeft:18,borderLeft:'2px solid var(--accent)'}}>
              The absence of this infrastructure is a biosecurity risk today. Its presence could accelerate safe, citizen-driven biological innovation at the scale the moment demands.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="wrap" style={{padding:'72px 0'}}>
        <div className="flex between center mb-40">
          ...
          <div className="mono" style={{fontSize:11,color:'var(--ink-3)',letterSpacing:'0.1em',textTransform:'uppercase'}}>Automated · open · auditable</div>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(4, 1fr)', borderTop:'0.5px solid var(--rule)', borderBottom:'0.5px solid var(--rule)'}}>
          {[
            {
              n: '01', title: 'Biosafety screening',
            ...
            {
              n: '03', title: 'Tamper-evident certificate',
            ...
            {
              n: '04', title: 'Contributor recognition',
      ...
      <section style={{background:'var(--paper-3)',padding:'88px 0'}}>
        <div className="wrap grid-12" style={{alignItems:'center',gap:48}}>
          <div style={{gridColumn:'span 5'}}>
            ...
            <button className="btn btn-ghost mt-24">Read the technical specification →</button>
          </div>
          <div style={{gridColumn:'span 6', gridColumnStart: 7}}>
            <div style={{background:'var(--paper-2)',border:'0.5px solid var(--rule)',borderRadius:6,padding:28}}>
              <div className="flex between center mb-16">
                <div className="mono" style={{fontSize:10.5,color:'var(--ink-3)',letterSpacing:'0.12em',textTransform:'uppercase'}}>Watermark · 128-bit · recovered</div>
      ...
      <section className="wrap" style={{padding:'88px 0'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:24,position:'relative'}}>
          <div style={{position:'absolute',top:24,left:'10%',right:'10%',height:'0.5px',background:'var(--rule)'}}/>
          {[
            ...
            <div key={s.n} style={{position:'relative',background:'var(--paper)',paddingTop:0}}>
              <div style={{
                width:48,height:48,borderRadius:'50%',background:'var(--paper)',border:'0.5px solid var(--ink)',
                display:'flex',alignItems:'center',justifyContent:'center',marginBottom:18,
                fontFamily:'var(--mono)',fontSize:12,position:'relative',zIndex:1
              }}>{s.n}</div>
      ...
      <section style={{background:'var(--ink)',color:'var(--paper)',padding:'96px 0'}}>
        <div className="wrap grid-12" style={{alignItems:'center',gap:48}}>
          ...
          <div style={{gridColumn:'span 6',gridColumnStart:7}}>
            <div className="eyebrow mb-16" style={{color:'rgba(247,243,236,0.6)'}}>§ 05 — The certificate</div>
            <h2 className="display" style={{fontSize:48,margin:'0 0 24px',color:'var(--paper)'}}>
              Every record is signed.<br/>Every signature is<br/><em style={{color:'var(--accent)'}}>public and verifiable.</em>
            </h2>
            <p style={{fontSize:16,lineHeight:1.6,color:'rgba(247,243,236,0.75)',maxWidth:540,marginBottom:32}}>
            ...
            <div style={{background:'rgba(247,243,236,0.06)',border:'0.5px solid rgba(247,243,236,0.2)',borderRadius:6,padding:'20px 24px',fontFamily:'var(--mono)',fontSize:11.5,lineHeight:1.8,color:'rgba(247,243,236,0.8)',letterSpacing:'0.02em'}}>
              <div style={{color:'var(--accent)'}}>// Verify any record</div>
              <div>$ artgene verify AG-2026-018427</div>
              <div style={{color:'rgba(247,243,236,0.5)'}}>  ↳ hash: a9f0c3e8...b41d — OK</div>
              <div style={{color:'rgba(247,243,236,0.5)'}}>  ↳ sig: ETH-ZURICH-PLATT-LAB — OK</div>
              <div style={{color:'rgba(247,243,236,0.5)'}}>  ↳ ledger: block 148,902 — OK</div>
      ...
      <section className="wrap" style={{padding:'88px 0'}}>
        ...
        <h2 className="display mb-40" style={{fontSize:36,textAlign:'center',margin:'0 auto 48px',maxWidth:720}}>
          ArtGene is operated as public-interest infrastructure — not a product.
        </h2>
        <div style={{display:'grid',gridTemplateColumns:'repeat(6,1fr)',gap:0,borderTop:'0.5px solid var(--rule)',borderBottom:'0.5px solid var(--rule)'}}>
          {['WELLCOME TRUST','NIH','EMBL-EBI','DDBJ','WHO BIOSEC','ARC INSTITUTE','CZI','BROAD','PASTEUR','CRICK','RIKEN','UCSF'].map((name,i)=>(
            <div key={i} style={{
              padding:'28px 20px',
      ...
      <section style={{background:'var(--paper-3)',padding:'80px 0',borderTop:'0.5px solid var(--rule)'}}>
        <div className="wrap-narrow" style={{textAlign:'center'}}>
          ...
          <div className="flex gap-12" style={{justifyContent:'center'}}>
            <button className="btn btn-primary" onClick={()=>setRoute('register')}>Begin deposit →</button>
            <button className="btn btn-ghost" onClick={()=>setRoute('docs')}>Read the documentation</button>
          </div>
        </div>
      </section>
    </div>
...
function PillarIcon({ kind }) {
  ...
  if (kind === 'shield') return (
    <svg width={s} height={s} viewBox="0 0 40 40" fill="none">
      <path d="M20 4 L34 9 V20 C34 28, 20 36, 20 36 C20 36, 6 28, 6 20 V9 L20 4Z" stroke="var(--ink)" strokeWidth="0.8"/>
      <path d="M20 4 L34 9 V20 C34 28, 20 36, 20 36" stroke="var(--accent)" strokeWidth="0.8"/>
      <path d="M14 19 L18 23 L26 15" stroke="var(--accent)" strokeWidth="1.2" fill="none"/>
    </svg>
  );
  if (kind === 'wm') return (
    <svg width={s} height={s} viewBox="0 0 40 40" fill="none">
      {[0,1,2].map(r => [0,1,2,3,4].map(c => (
        <rect key={r+'-'+c} x={6+c*6} y={10+r*6} width="4" height="4" rx="0.5"
          fill={[1,3,5,7,9,11].includes(r*5+c) ? 'var(--accent)' : 'var(--rule)'}/>
      )))}
    </svg>
  );
  if (kind === 'cert') return (
    <svg width={s} height={s} viewBox="0 0 40 40" fill="none">
      <circle cx="20" cy="18" r="12" stroke="var(--ink)" strokeWidth="0.8"/>
      <circle cx="20" cy="18" r="8" stroke="var(--accent)" strokeWidth="0.8"/>
      <path d="M16 32 L14 38 L20 35 L26 38 L24 32" stroke="var(--ink)" strokeWidth="0.8" fill="var(--paper-2)"/>
    </svg>
  );
  if (kind === 'star') return (
    <svg width={s} height={s} viewBox="0 0 40 40" fill="none">
      <circle cx="20" cy="20" r="14" stroke="var(--ink)" strokeWidth="0.8"/>
      <path d="M20 10 L22 18 L30 18 L23.5 23 L26 31 L20 26 L14 31 L16.5 23 L10 18 L18 18 Z" fill="var(--accent)" opacity="0.2" stroke="var(--accent)" strokeWidth="0.8"/>
    </svg>
  );
  return null;
}
